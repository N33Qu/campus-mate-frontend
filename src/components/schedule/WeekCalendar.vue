  ...
  <div class="bg-white rounded-lg shadow">
      ...
      >
        <div class="space-y-1">
          <div
              ...
              :key="event.id"
              class="rounded-lg p-1 md:p-2 cursor-pointer hover:opacity-90 transition-opacity duration-200 bg-element text-headerText"
    ...
    >
      ...
      >
        ...
        <button
            @click="closeModal"
            class="mt-4 w-full px-4 py-2 bg-cancelButton text-white rounded-lg hover:bg-cancelButtonHover transition-colors duration-200"
        >
          Zamknij
        </button>
      </div>
